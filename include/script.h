...
void m_1newworld()
{
	if(script[mainscript] == 1){
		...
		if(script[cutscene] == 17)
			script[cutscene] = 1, script[mainscript]++,
			//objective = "[Идти в магазин на Горной улице]",
			hr = 19, mn = 48;
	}
	else if(script[0] == 6){
...
void m_4nightbrawl()
{
	...
	if(script[0] == 1){
		...
		//objective = "Попасть в ночной клуб";
		if(y == 30 && x == 42)
			script[0]++;
	}
	else if(script[0] == 3){
		//objective = "Идти в туалет и освободить Мэй";
		if(y == 30 && x == 42)
			script[0]++;
	}
	else if(script[0] == 4){
		//objective = "Покинуть здание и провести Мэй до общежития гиков";
		if(y == 30 && x == 42)
			script[0]++;
	}
	else if(script[0] == 5){
...
void m_cuttingarms()
{
	...
	if(script[0] == 2){
		//objective = "Остановить Толяна, пока он цел";
		if(y == 30 && x == 42)
			script[0]++;
	}
	else if(script[0] == 3){
		...
		//objective = "Проникнуть в квартиру Толяна";
		if(y == 30 && x == 42)
			script[0]++;
	}
	else if(script[0] == 5){
		...
		//objective = "Нейтрализовать Толяна";
		if(npc[0][npc_HP] <= 2)
			script[0]++;
	}
	else if(script[0] == 7){
		//objective = "Отвезти Толяна в медпункт";
		if(y == 30 && x == 42)
			script[0]++;
	}
	else if(script[0] == 8){
...
void m_batduel()
{
	...
	if(script[0] == 4)
	{
		if(script[1] == 0){
			doomerrespect += 0.2;
			Caption("<Уважение думеров +20%>");\
		}
		if(script[1] == 1){
			doomerrespect += 0.1;
			Caption("<Уважение думеров +10%>");
		}
		if(script[1] == 2){
			doomerrespect += 0.25;
			Caption("<Уважение думеров +25%>");
		}
...
void m_artofvandalism()
{
	if(script[0] == 1)
	{
		//objective = "Идти в парк";
		weapon[5] = iPaintSpray;
		script[0]++;
	}
	else if(script[0] == 2)
	{
		//objective = "Раскрасьте дорогу в парк";
		script[0]++;
	}
	else if(script[0] == 3)
	{
		//objective = "Снимите работу на камеру";
		script[0]++;
	}
	else if(script[0] == 4)
	{
...
void m_spit()
{
	if(script[0] == 1){
		...
		//objective = "Выбраться из заброшенной церкви";
		script[0]++;
	}
	else if(script[0] == 3){
		//objective = "Спуститься с горы";
		if(location != mountaintop)
			script[0]++;
	}
	else if(script[0] == 4){
		//objective = "Покинуть гору";
